    ...
    <div class="footer-container">
      <div class="footer-content">
        ...
        <div class="footer-right">
          ...
          <a href="https://github.com/berkayoztunc/p402" target="_blank" rel="noopener" class="social-btn">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
      ...
      <div class="footer-bottom">
        <span class="copyright">© 2025 P402</span>
        <span class="divider">•</span>
        <span class="powered">Powered by Solana</span>
      </div>
    </div>
  </footer>
</template>
